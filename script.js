(() => {
  ...
  const I18N = {
    en: {
      ...
      "home.pouch.use_step_3": "Keep it in place for about 60 seconds, or up to 5 minutes if preferred.",
      "home.pouch.use_step_4": "Put the used pouch into the lid compartment before disposal.",
      "home.featured.title": "Our Collections",
    ...
    pt: {
      ...
      "home.pouch.use_step_3": "Mantenha-a no lugar por cerca de 60 segundos, ou até 5 minutos se preferir.",
      "home.pouch.use_step_4": "Coloque a bolsa usada no compartimento da tampa antes de descartar.",
      "home.featured.title": "As nossas coleções",
    ...
    es: {
      ...
      "home.pouch.use_step_3": "Déjala en su lugar unos 60 segundos, o hasta 5 minutos si lo prefieres.",
      "home.pouch.use_step_4": "Pon la bolsa usada en el compartimento de la tapa antes de desecharla.",
      "home.featured.title": "Nuestras colecciones",
